...
public class DepositController {
    ...
    public Response deposit(String amount){
        ...
        return costumerAccount.deposit(amountConverted);
    }


    public void goToSucessDeposit(ActionEvent actionEvent) throws IOException {
        Response depositResponse = deposit(depositValueInput.getText());
